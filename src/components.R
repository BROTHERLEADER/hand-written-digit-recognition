...
component.about <-
  div(
    ...
    p(paste(
      ...
      'Additionally, by clicking the download button located on the top-right side, you can download all image data and',
      'the labels associated with the each image, so you can improve the model by yourself.'
    )),
    HTML('<p>Source code: <a href="https://github.com/riomat13/hand-written-digit-recognition" target="_blank" rel="noopener noreferrer">github</a>'),
  )